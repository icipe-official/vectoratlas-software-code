...
(id, biting_number_of_sampling_nights_indoors, biting_sampling_indoor, biting_number_of_sampling_nights_outdoors, biting_sampling_outdoor, indoor_outdoor_biting_unit, indoor_biting_n, indoor_biting_total, indoor_biting_data, outdoor_biting_n, outdoor_biting_total, outdoor_biting_data, indoor_outdoor_biting_notes)
...
(id, resting_sampling_indoor, resting_sampling_outdoor, resting_sampling_other, resting_unit, unfed_indoor, fed_indoor, gravid_indoor, total_indoor, unfed_outdoor, fed_outdoor, gravid_outdoor, total_outdoor, unfed_other, fed_other, gravid_other, total_other, resting_notes)
...
VALUES(E'{id}', E'{roof}', E'{walls}', {house_screening}, {open_eaves}, E'{cooking}', {sleeping_outdoors}, E'{farming}', E'{local_plants}', E'{housing_notes}', E'{community_notes}', E'{farming_notes}', E'{livestock_notes}', E'{common_occupation_1}', E'{common_occupation_2}', E'{common_occupation_3}', E'{outdoor_timings_hours}', E'{outdoor_activities_notes}', E'{average_bedtime}', E'{average_wake_time}', E'{time_people_leave_home_in_morning}', E'{hours_spent_away_from_home_per_day}', E'{seasonal_labour}', E'{livestock_1}', E'{livestock_2}', E'{livestock_3}', E'{livestock_4}', E'{environment_notes}', E'{outdoor_activities_at_night}', E'{forest}');"""
...
VALUES(E'{id}', {adult_data}, {larval_site_data}, {contact_authors}, E'{contact_notes}', E'{secondary_info}', {insecticide_control}, E'{control}', {month_start}, {year_start}, {month_end}, {year_end}, E'{season_given}', E'{season_calc}', E'{data_abstracted_by}', E'{data_checked_by}', E'{control_notes}', E'{season_notes}', E'{referenceId}', E'{siteId}', E'{biologyId}', E'{infectionId}', E'{bitingRateId}', E'{anthropoZoophagicId}', E'{endoExophagicId}', E'{bitingActivityId}', E'{endoExophilyId}', E'{study_sampling_design}', {itn_use}, E'{environmentId}', E'{datasetId}', E'{insecticide_resistance_data}', E'{rainfall_time}', E'{larvalSiteId}');"""

template_insert_sample_method_data = """INSERT INTO public.sample
(id, "control", control_type, sampling_occurrence_1, occurrence_n_1, sampling_occurrence_2, occurrence_n_2, sampling_occurrence_3, occurrence_n_3, sampling_occurrence_4, occurrence_n_4, occurrence_n_total, occurrence_notes)
VALUES(E'{id}', {control}, E'{control_type}', E'{sampling_occurrence_1}', {occurrence_n_1}, E'{sampling_occurrence_2}', {occurrence_n_2}, E'{sampling_occurrence_3}', {occurrence_n_3}, E'{sampling_occurrence_4}', {occurrence_n_4}, {occurrence_n_total}, E'{occurrence_notes}');"""
...
confidentiality_status, source_id, bio_data, personal_communication, source_notes, pheno_data, geno_data, season_given, season_calc)
...
template_occurrence_update_insecticide_resistance_data = """update occurrence  set "insecticideResistanceBioassaysId" = E'{insecticideResistanceBioassaysId}' where id = E'{occ_id}' """
...
(id, genotypic_test_representative_of_species_at_site, genotypic_repr_species_site_disagg_no_adj, minor_species_missing_allele_frequency_data, notes_on_population_representative, genotypic_sample_first_been_through_bioassay_tests, genotypic_sample_linked_to_a_specific_bioassay, bioassay_subsample_used_in_genotypic_test, notes_on_bioassay_linkage)
VALUES('{id}', E'{genotypic_test_representative_of_species_at_site}', E'{genotypic_test_representative_of_species_at_site_if_disaggregated_values_combined_without_adjustments}', E'{minor_species_missing_allele_frequency_data}', E'{notes_on_population_representative}', E'{genotypic_sample_first_been_through_bioassay_tests}', E'{genotypic_sample_linked_to_a_specific_bioassay}', E'{bioassay_subsample_used_in_genotypic_test}', E'{notes_on_bioassay_linkage}');"""

template_insert_vgscmethodandsample_data = """INSERT INTO public."vgscMethodAndSample"
(id, vgsc_method_1, vgsc_method_2, vgsc_number_of_mosquitoes_tested, vgsc_generation, vgsc_kdr_notes)
VALUES('{id}', E'{vgsc_method_1}', E'{vgsc_method_2}', E'{vgsc_number_of_mosquitoes_tested}', E'{vgsc_generation}', E'{vgsc_kdr_notes}');"""

template_insert_vgscgeneytpefrequencies_data = """INSERT INTO public."vgscGeneytpeFrequencies"
(id, vgsc995l_vgsc995l_n, vgsc995l_vgsc995l_percent, vgsc995l_vgsc995f_n, vgsc995l_vgsc995f_percent, vgsc995f_vgsc995f_n, vgsc995f_vgsc995f_percent, vgsc995l_vgsc995s_n, vgsc995l_vgsc995s_percent, vgsc995s_vgsc995s_n, vgsc995s_vgsc995s_percent, vgsc995l_vgsc995c_n, vgsc995l_vgsc995c_percent, vgsc995c_vgsc995c_n, vgsc995c_vgsc995c_percent, null_vgsc995c_or_vgsc995c_vgsc995c_n, null_vgsc995c_or_vgsc995c_vgsc995c_percent, vgsc995f_vgsc995s_n, vgsc995f_vgsc995s_percent, vgsc995f_vgsc995c_n, vgsc995f_vgsc995c_percent)
VALUES('{id}', E'{vgsc995l_vgsc995l_n}', E'{vgsc995l_vgsc995l_percent}', E'{vgsc995l_vgsc995f_n}', E'{vgsc995l_vgsc995f_percent}', E'{vgsc995f_vgsc995f_n}', E'{vgsc995f_vgsc995f_percent}', E'{vgsc995l_vgsc995s_n}', E'{vgsc995l_vgsc995s_percent}', E'{vgsc995s_vgsc995s_n}', E'{vgsc995s_vgsc995s_percent}', E'{vgsc995l_vgsc995c_n}', E'{vgsc995l_vgsc995c_percent}', E'{vgsc995c_vgsc995c_n}', E'{vgsc995c_vgsc995c_percent}', E'{null_vgsc995c_or_vgsc995c_vgsc995c_n}', E'{null_vgsc995c_or_vgsc995c_vgsc995c_percent}', E'{vgsc995f_vgsc995s_n}', E'{vgsc995f_vgsc995s_percent}', E'{vgsc995f_vgsc995c_n}', E'{vgsc995f_vgsc995c_percent}');"""

template_insert_kdrgenotypefrequencies_data = """INSERT INTO public."kdrGenotypeFrequencies"
(id, susceptible_susceptible_n, susceptible_susceptible_percent, resistant_susceptible_n, resistant_susceptible_percent, resistant_resistant_n, resistant_resistant_percent)
...
(id, "vgsc402v_vgsc402v_n", "vgsc402v_vgsc402v_percent", "vgsc402v_vgsc402l_n", "vgsc402v_vgsc402l_percent", "vgsc402l_vgsc402l_n", "vgsc402l_vgsc402l_percent")
...
(id, vgsc402v_percent, "vgsc_402l_percent")
...
(id, "cyp6aap_wt_percent", "cyp6aap_dup1_percent")
...
(id, "cyp6aap_wt_cyp6aap_wt_n", "cyp6aap_wt_cyp6aap_wt_percent", "cyp6aap_wt_cyp6aap_dup1_n", "cyp6aap_wt_cyp6aap_dup1_percent", "cyp6aap_dup1_cyp6aap_dup1_n", "cyp6aap_dup1_cyp6aap_dup1_percent")
...
(id, "cyp6p4_236wt_percent", "cyp6p4_236m_percent")
...
(id, "cyp6p4_236wt_cyp6p4_236wt_n", "cyp6p4_236wt_cyp6p4_236wt_percent", "cyp6p4_236wt_cyp6p4_236m_n", "cyp6p4_236wt_cyp6p4_236m_percent", "cyp6p4_236m_cyp6p4_236m_n", "cyp6p4_236m_cyp6p4_236m_percent")
...
(id, "cyp4j5_43l_percent", "cyp4j5_43f_percent")
...
(id, "cyp4j5_43l_cyp4j5_43l_n", "cyp4j5_43l_cyp4j5_43l_percent", "cyp4j5_43l_cyp4j5_43f_n", "cyp4j5_43l_cyp4j5_43f_percent", "cyp4j5_43f_cyp4j5_43f_n", "cyp4j5_43f_cyp4j5_43f_percent")
...
(id, "gste2_119l_gste2_119l_n", "gste2_119l_gste2_119l_percent", "gste2_119l_gste2_119v_n", "gste2_119l_gste2_119v_percent", "gste2_119v_gste2_119v_n", "gste2_119v_gste2_119v_percent")
...
(id, "gste2_114I_gste2_114I_n", "gste2_114I_gste2_114I_percent", "gste2_114I_gste2_114t_n", "gste2_114I_gste2_114t_percent", "gste2_114t_gste2_114t_n", "gste2_114t_gste2_114t_percent")
...
(id, "vgsc1570n_vgsc1570n_n", "vgsc1570n_vgsc1570n_percent", "vgsc1570n_vgsc1570y_n", "vgsc1570n_1570y_percent", "vgsc1570y_vgsc1570y_n", "vgsc1570y_vgsc1570y_percent")
...
(id, rdl_method_1, rdl_number_of_mosquitoes_tested, rdl_generation, rdl_notes)
VALUES('{id}', E'{rdl_method_1}', E'{rdl_number_of_mosquitoes_tested}', E'{rdl_generation}', E'{rdl_notes}');"""

template_insert_rdl296GenotypeFrequencies_data = """INSERT INTO public."rdl296GenotypeFrequencies"
(id, "rdl296c_rdl296c__n", "rdl296c_rdl296c_percent", "rdl296c_rdl296g_n", "rdl296c_rdl296g_percent", "rdl296g_rdl296g_n", "rdl296g_rdl296g_percent", "rdl296c_rdl296s_n", "rdl296c_rdl296s_percent", "rdl296s_rdl296s_n", "rdl296s_rdl296s_percent", "rdl296g_rdl296s_n", "rdl296g_rdl296s_percent")
VALUES('{id}', E'{rdl296c_rdl296c__n}', E'{rdl296c_rdl296c_percent}', E'{rdl296c_rdl296g_n}', E'{rdl296c_rdl296g_percent}', E'{rdl296g_rdl296g_n}', E'{rdl296g_rdl296g_percent}', E'{rdl296c_rdl296s_n}', E'{rdl296c_rdl296s_percent}', E'{rdl296s_rdl296s_n}', E'{rdl296s_rdl296s_percent}', E'{rdl296g_rdl296s_n}', E'{rdl296g_rdl296s_percent}');"""
...
(id, ace1_method_1, ace1_number_of_mosquitoes_tested, ace1_generation, ace1_notes)
VALUES('{id}', E'{ace1_method_1}', E'{ace1_number_of_mosquitoes_tested}', E'{ace1_generation}', E'{ace1_notes}');"""

template_insert_ace1GenotypeFrequencies_data = """INSERT INTO public."ace1GenotypeFrequencies"
(id, "ace1_280g_ace1_280g_n", "ace1_280g_ace1_280g_percent", "ace1_280g_ace1_280s_n", "ace1_280g_ace1_280s_percent", "ace1_280s_ace1_280s_n", "ace1_280s_ace1_280s_percent")
