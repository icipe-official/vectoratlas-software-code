...
That's the basic process for exploring, viewing and downloading data. You can catch up with the latest news from the project using the [News](https://test.vectoratlas.icipe.org/news) link in the top navigation bar or find out more about the project in the [About](https://test.vectoratlas.icipe.org/about) page.
