...
## Getting to the map
To get to the map click on the map on the homepage, or use the map link in the top navigation bar – both will redirect to the [/map](https://test.vectoratlas.icipe.org/map) route
