...
export class dbTroubleshoot1666700041387 implements MigrationInterface {
    name = 'dbTroubleshoot1666700041387'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "environment" ("id" character varying(256) NOT NULL, "roof" character varying(50), "walls" character varying(50), "house_screening" boolean, "open_eaves" boolean, "cooking" character varying(50), "housing_notes" character varying, "occupation" character varying(50), "outdoor_activities_night" boolean, "sleeping_outdoors" boolean, "community_notes" character varying, "farming" character varying(50), "farming_notes" character varying, "livestock" character varying(50), "livestock_notes" character varying, "local_plants" character varying(50), CONSTRAINT "PK_f0ec97d0ac5e0e2f50f7475699f" PRIMARY KEY ("id"))`);
