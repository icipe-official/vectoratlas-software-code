...
export class AddIsvalidatedAndDatasetType1740063563314
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "uploaded_dataset" ADD "dataset_type" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "uploaded_dataset" ADD "is_validated" boolean`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "uploaded_dataset" DROP COLUMN "is_validated"`,
    );
    await queryRunner.query(
      `ALTER TABLE "uploaded_dataset" DROP COLUMN "dataset_type"`,
    );
  }
}
