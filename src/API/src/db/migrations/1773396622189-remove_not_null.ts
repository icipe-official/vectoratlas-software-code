...
export class RemoveNotNull1773396622189 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        //await queryRunner.query(`ALTER TABLE "insecticideResistanceBioassays" RENAME COLUMN "bioassay_representative_of_complex_at_site_if_disaggregated_val" TO "bioassay_representative_of_complex_at_site_if_disaggregated_values_combined_without_adjustments"`);
