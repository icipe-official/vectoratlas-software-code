...
export class AddFieldsToDatasetTable1730856580674 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dataset" ADD "dataType" character varying`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "dataSource" character varying`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "description" text`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "title" character varying`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "location" character varying`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "region" character varying`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "fileName" character varying NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "fileSize" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "dataset" ADD "fileType" character varying NOT NULL DEFAULT ''`);
    }
