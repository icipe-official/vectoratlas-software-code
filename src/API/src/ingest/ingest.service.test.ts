...
const biology_rows = [
  {
    ...
    parity_total: '43',
    parity_percent: '44',
    daily_survival_rate_percent: '45',
    fecundity_mean_batch_size: '46',
