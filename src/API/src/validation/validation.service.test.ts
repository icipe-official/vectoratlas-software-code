...
describe('ValidationService', () => {
  ...
  describe('validateBionomicsCsv', () => {
    it('Validator is initialised with correct arguments for bionomics and returns no errors for complete and correct csv data', async () => {
      ...
      expect(Validator).toHaveBeenCalledTimes(2);
      expect(Validator).toHaveBeenCalledWith("bionomics", {"Adult data": "TRUE", "Article title": "Malaria infection, morbidity and transmission in two ecological zones Southern Ghana", "Country": "Ghana", "HBR (unit)": "HBR (night)", "HBR sampling (combined)_1": "MBI", "HBR sampling (combined)_2": "MBO", "ID": "4", "Journal title": "Afr J Health Sci", "Larval site data": "FALSE", "Latitude": "5.883", "Longitude": "-0.118", "MAP site id": "28912", "Month_end": "11", "Month_st": "11", "Season (calc)": "rainy", "Site": "Dodowa", "Species_1": "gambiae", "Year_end": "1992", "Year_st": "1992", "author": "Afari", "citation": "Malaria infection, morbidity and transmission in two ecological zones Southern Ghana", "combined HBR": "3.13", "enlid": "355", "insecticide control": "FALSE", "num_id": "1", "species": "gambiae", "Year": "1995"}, 0);
      expect(Validator).toHaveBeenCalledWith("bionomics", {"Adult data": "TRUE", "Article title": "Malaria transmission in a central area of Futa Dialon (Guinea): results of a parasitological survey during the 1989 rainy season", "Country": "Guinea", "ID": "5", "Journal title": "Parassitologia", "Larval site data": "FALSE", "Latitude": "4.324", "Longitude": "0.231", "MAP site id": "1000000305", "Month_end": "8", "Month_st": "8", "SR by CSP ( %)": "7.6", "SR by CSP (total)": "355", "Season (given)": "rainy", "Site": "Daka (Labe), Sombili, Timbi Madina", "Species_1": "gambiae", "Year_end": "1989", "Year_st": "1989", "author": "Bosman", "citation": "Malaria transmission in a central area of Futa Dialon (Guinea): results of a parasitological survey during the 1989 rainy season", "enlid": "386", "host (unit)": "HBI (%)", "host sampling (indoor)": "HRI", "id_2": "cyto", "indoor host %": "78", "insecticide control": "FALSE", "num_id": "2", "sampling (infection)_1": "HRI", "species": "gambiae", "Year": "1992"}, 1);
