            ...
            >
              ...
              {(() => {
                ...
                try {
                  ...
                  console.error('Invalid JSON in speciesDetails.description:', e);
                  return <Typography color="error">Invalid description format</Typography>;
                }
                ...
                return Array.isArray(sections) ? (
                  ...
                  <Typography color="error">Description is not a valid array</Typography>
                );
              })()}
            </Box>
              <Typography
