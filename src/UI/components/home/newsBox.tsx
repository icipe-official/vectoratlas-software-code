  ...
  return (
    <Paper>
      <Box overflow="auto" flex={1} flexDirection="column" display="flex" flex-grow="1" p={2} >
        ...
        <Grid container display="flex" width={'100%'} justifyContent="center" pb={2}>
          <Grid item md={8}>
          ...
          We will be attending the 8th PAMCA Annual Conference from 26-28 September 2022 and are excited to attending the sessions and events and hear about the ongoing work in vector research and control. We also look forward to connecting with current and new collaborators at this event.
              <br />
              <br />
          Please join us for our presentation on <strong>Tuesday 27 September at 10:30 in Parallel Session 8, room AD12</strong> where we will showcase <strong>The Vector Atlas</strong>. Hope to see you there!

            </Typography>
          </Grid>
          <Grid item md={4} style={{display: 'flex', justifyContent: 'center', width: '100%'}}>
            <picture>
