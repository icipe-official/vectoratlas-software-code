import { Avatar, Button, Grid, List, ListItem, ListItemAvatar, TextareaAutosize, TextField } from "@mui/material";
            ...
            <div>
                <Grid container spacing={3}>
                    <Grid item sm={12} md={4}>
                        <div>
                            <TextField id="outlined-basic" value={props.dataset_id} label="Dataset ID" disabled={true} variant="outlined" />
                        </div>
                    </Grid>
                    <Grid item sm={12} md={4}>
                        <div>
                            <TextField id="outlined-basic" value={"demo@user.com"} label="Data uploaded by" disabled={true} variant="outlined" />
                        </div>
                    </Grid>
                    <Grid item sm={12} md={4}>
                        <div>
