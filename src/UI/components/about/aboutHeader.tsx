  ...
  return (
    <Box>
      <Typography variant='body1' sx={{paddingBottom: 3}}>
        ...
        building a data-hub that links &apos;core&apos; African vector occurrence, bionomics and insecticide resistance data to provide a  &apos;one stop shop&apos;
        of relatable and cross-referenced data access. Using our standardised and comprehensive collation protocols (Hay et al 2010) to abstract data from the published 
        and grey literature (maintaining all data ownership), we are updating our core datasets (Sinka et al (2010), Massey et al (2016), Moyes et al (2020)) which 
